<form method="POST" action="{{ route('pet.store') }}" id="pet-form">
    @csrf
    ...
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="sm:col-span-full">
                ...
                <div class="mt-2">
                    <select id="type" name="type" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" required>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <button type="submit" class="submit rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Opslaan</button>
        </div>
    </div>
</form>
